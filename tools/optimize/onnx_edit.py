...
"""
Usage:
$ python onnx_edit.py yolov3.opt.onnx yolov3-p4p5.opt.onnx --outputs 371,391 --skipverify
$ python onnx_edit.py yolov5s.opt.onnx yolov5s-p3p4.opt.onnx --outputs 397,458 --skipverify
$ python onnx_edit.py yolov5s.v5.opt.onnx yolov5s-p3p4.v5.opt.onnx --outputs 397,417 --skipverify
"""
